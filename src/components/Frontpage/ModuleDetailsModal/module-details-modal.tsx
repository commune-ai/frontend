...
export default function ModuleDetailsModal({ isOpen, onClose, moduleName }) {
  ...
  return (
    <Popup className={classNames(classes.popup, "bg-teal-100")} isOpen={isOpen} onClose={onClose}>
...
function SchemaNameElement({ children, name }) {
  return (
...
function InputElement({ name, type, defaultValue }) {
