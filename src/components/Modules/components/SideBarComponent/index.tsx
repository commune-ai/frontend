...
export default function ExtraSidebar() {
  ...
  return (
    <>
    <aside className={`flex-shrink-0 flex overflow-hidden flex-col border-r dark:border-r-gray-700 transition-all duration-500`}>
                            ...
                            <Disclosure.Panel className="space-y-1">
                              {item.children.map((subItem) => (
                                <Link
                                  key={subItem.name}
                                  to={subItem.href}
                                  className={"group flex w-full items-center rounded-md py-2 pl-11 pr-2 text-sm font-medium"}
                                >
                                  {subItem.name}
                                </Link>
                              ))}
