  ...
  const createBTCTx = async (toAddress: string, value: number, env: string, fromAddress: string) => {
    try {
      ...
      let data = JSON.stringify({
        inputs: [
          {
            addresses: [`${fromAddress}` /* "n1TKu4ZX7vkyjfvo7RCbjeUZB6Zub8N3fN" */],
          },
        ],
        outputs: [
          {
  ...
  return (
    <nav aria-label="Main" className={classes.navbar}>
      <div className={classes.items}>
        ...
        <ActiveLink activeClassName={classes.activeModules} className={classNames("dark:text-white dark:hover:text-[#dc4b4b] dark:active:text-[#dc4b4b]", classes.item)} href="/modules">
          🚀 Modules
        </ActiveLink>
        <ActiveLink activeClassName={classes.activeDocs} className={classNames("dark:text-white dark:hover:text-[#6a4bdc] dark:active:text-[#6a4bdc]", classes.item)} href="/docs/introduction">
          📚 Docs
        </ActiveLink>
        <Link className={classNames("dark:text-white dark:hover:text-[#d2d522] dark:active:text-[#d2d522]", classes.item)} href="https://ai-secure.github.io/DMLW2022/assets/papers/7.pdf" target="_blank" rel="noopener noreferrer">
          📄 Whitepaper
        </Link>
        <ActiveLink activeClassName={classes.active} className={classNames("dark:text-white dark:hover:text-[#25c2a0] dark:active:text-[#25c2a0]", classes.item)} href="/telemetry">
          ⛓️ Telemetry
        </ActiveLink>
        <ActiveLink activeClassName={classes.active} className={classNames("dark:text-white dark:hover:text-[#25c2a0] dark:active:text-[#25c2a0]", classes.item)} href="/exchanges">
          💱 Exchanges
        </ActiveLink>
        <Link className={classNames("dark:text-white dark:hover:text-[#25c2a0] dark:active:text-[#25c2a0]", classes.item)} href="https://comchat.io/" target="_blank" rel="noopener noreferrer">
          🥂 ComChat
        </Link>

        <Dropdown menu={{ items: paymentMethods, onClick }}>
          <Space>
            <ActiveLink activeClassName={classes.active} className={classNames("dark:text-white dark:hover:text-[#25c2a0] dark:active:text-[#25c2a0]", classes.item)} href="#">
              💰 Payment
            </ActiveLink>
          </Space>
        </Dropdown>
      ...
      <div className={classNames("dark:text-white", classes.items, classes.itemsRight)}>
        <Link className={classNames("dark:hover:text-[#25c2a0] dark:active:text-[#25c2a0]", classes.link)} href="/docs/next/Introduction">
          🚀 v0.0.0
        </Link>
        ...
        <div className={classNames(classes.dropdown, "z-[9999]")}>
          ...
          <ul className={classNames(classes.dropdownMenu, "dark:bg-white dark:text-black w-32")}>
            <li>
              <Link className={classNames(classes.dropdownLink)} href="https://discord.gg/communeai" target="_blank" rel="noopener noreferrer">
      ...
      {isShowWalletPaymentModal && (
        <Modal open={isShowWalletPaymentModal} onCancel={handleWalletPaymentModalOpen} footer={null}>
          <div className="flex flex-col">
            ...
            <input value={destinationAddress} onChange={({ target: { value } }) => setDestinationAddress(value)} style={{ padding: "0.3rem" }} className="mt-2 !border-2 !border-gray-400 rounded" placeholder="Please input wallet address" />
            <div className="flex items-center mt-4">
              ...
              <input type="number" value={amount} onChange={({ target: { value } }) => setAmount(value)} style={{ padding: "0.3rem" }} placeholder="0.00" className="!border-2 !border-gray-400 rounded" />
            </div>
                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{ display: "flex", gap: 12 }} className="flex items-center justify-between mt-4">
                          <button onClick={openChainModal} style={{ display: "flex", alignItems: "center" }} type="button" className="uppercase">
                            {chain.hasIcon && (
                              <div
                                style={{
