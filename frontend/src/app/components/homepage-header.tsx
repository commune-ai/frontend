...
export default function HomepageHeader() {
	...
	return (
		<header
			ref={headerRef}
			className={` dark:bg-[#161616] p-[4rem] py-32 text-center overflow-hidden ${getHeaderClasses(
				scrollPosition,
				headerHeight
			)} duration-500`}
		>
			...
			{isShowSubstrateConnectModalOpen && (
				<Modal
					...
					onCancel={handleShowSubstrateModalCancel}
					footer={null}
					width={500}
				>
			...
			{isShowAuthModalOpen && (
				<Modal
					...
					onCancel={handleShowAuthModalCancel}
					footer={null}
					width={500}
				>
