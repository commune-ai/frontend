...
function DiscordIcon() {
  return (
    <svg style={{ display: "inline-block" }} fill="#7289da" width="15" height="9" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 127.14 96.36">
      <g>
  ...
  return (
    <div className={classes.wrapper}>
      <div className="banner">
        ✨<span>Million</span>✨ tokens minted so far... 🚀🌙, Follow the project on our 
