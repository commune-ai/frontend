      ...
      <div className={classes.container}>
        <div className={classes.row}>
          ...
          <div className={classes.col}>
            ...
            <ul className={classes.list}>
              <li className={classes.item}>
                <a href="https://discord.gg/communeai" target="_blank" rel="noopener noreferrer" className={classes.link}>
                  Discord
                  <OpenIcon />
                </a>
              </li>
        ...
        <div className={classes.copyright}>Copyright © 2023 Commune, Inc. Built with Docusaurus.</div>
      </div>
    </footer>
  );
}
