...
const ProfileEditPage: React.FC = () => {
  ...
  const handleSaveUserProfile = () => {
    ...
    axios
      .post("http://localhost:8000/authentication/profile/", formData, {
        headers: {
        ...
        <div className="bg-[#f5f5f5] h-full rounded-xl dark:bg-[#2B2B33]">
          <div className="flex items-center justify-center p-10">
            ...
            <div className="flex flex-col">
              <h1 className="">Alan Guerrero</h1>
              <span className="dark: text-gray-500">Alan1201</span>
            </div>
          </div>
          ...
          <div
            style={{
              backgroundImage:
                "linear-gradient(to right,rgb(190 191 195), rgb(101 101 101))",
            }}
            className="p-2 w-full mt-5 cursor-pointer hover:text-black"
          >
      ...
      <div className="w-[60%] dark:text-white flex items-start dark:bg-[#212324] flex-col">
        <div className="mt-5 flex flex-col w-[80%]">
          ...
          <textarea
            ...
            className="dark:bg-slate-600 dark:text-white flex justify-center p-2 w-full rounded-md"
          />
          ...
          <label className="mt-[4rem]">
            Avatar <span className="dark:text-gray-500">(Optional)</span>
          </label>
          <Upload
          ...
          <button
            className="gap-2 border-[rgb(229 231 235)] w-[20%] inline-flex cursor-pointer items-center justify-center rounded-[0.5rem] border-[1px] p-1 hover:scale-105"
