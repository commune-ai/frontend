...
const StakedUsersTable = ({ stakedUsers }: { stakedUsers: [] }) => {
  ...
  return (
    <div className="max-w-full overflow-x-hidden dark:text-white">
      <div className="relative flex items-center flex-1 mb-3">
        <input
          type="text"
          onChange={(e) => setSearch(e.target.value)}
          className="relative  border-[1px] w-full h-[50px] rounded-xl text-[30px] pl-10"
        ...
        <div className="bg-gray-100 p-3 hidden md:block">
          <div className="grid grid-cols-[10%_70%_20%] gap-3">
            <div className="flex items-center justify-center">
              <p className="text-[30px] text-gray-500 font-semibold mx-auto">No</p>
            </div>
            <div className="flex items-center justify-center">
              <p className="text-[30px] text-gray-500 font-semibold">Address</p>
            </div>
            <div className="flex items-center justify-center">
              <p className="text-[30px] text-gray-500 font-semibold">Amount</p>
            </div>
          </div>
        </div>
        <div className="px-3 dark:text-white">
          {stakedUsers
            ...
            .map((user, index) => (
              <div
                key={index}
                className={`dark: text-white grid grid-cols-1 md:grid-cols-[10%_70%_20%] gap-3 items-center py-3 border-b ${index === stakedUsers.length - 1 ? "border-0" : ""
                  }`}
              >
                <div className="text-[28px] text-gray-800 dark:text-white flex items-center justify-center">
                ...
                <div className="">
                  <p className="text-[28px] text-gray-800 dark:text-white text-left flex items-center justify-center">
