  ...
  return (
    <div className="flex h-[70vh]">
      <div className="w-[40%] bg-gray-400 dark:bg-[#212324] dark:text-white flex flex-col items-center justify-start">
        ...
        />
        <h1 className="mt-4">Alan Guerrero</h1>
        <div className="flex mt-4">
          <button
            className="gap-2 border-[rgb(229 231 235)] inline-flex cursor-pointer items-center justify-center rounded-[0.5rem] border-[1px] p-2 hover:scale-105"
