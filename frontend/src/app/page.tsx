	...
	return (
		<div id={id} className="pt-10">
			<div className="py-10 px-5">
				<div
					className={`${backgroundClassName} mt-10 flex lg:flex-row flex-col items-center justify-center gap-10`}
				>
					<div className="flex-none lg:-mr-4 m-10 mt-20">
						<img className="w-[200px] h-[200px] duration-300" src={imageUrl} />
					</div>
	...
	return (
		<main className={classNames(classes.main, "flex flex-col ")}>
			...
			<SectionWrapper
				...
				backgroundClassName="dark:bg-gradient-to-b from-blue-300 to-[#84b9f7] bg-[linear-gradient(180deg,#ffffff,#84b9f7)] dark:bg-[linear-gradient(180deg,#181a1b,#083c7a)]"
			>
				<div className="text-black">
					<div className="pt-6 text-right w-full pb-10">
						<h1 className="text-5xl pt-6 pb-6 text-center dark:text-white">
							Networking & Wrapping <br />
							Over Everything 🌐
						</h1>
								...
								<div className="w-[30rem] mx-auto my-auto font-semibold text-lg">
									<ul className="text-left list-disc dark:text-white">
										...
										<li>
											...
											across different tools, leading to inefficiencies and time
											wastage.
										</li>
										<li>
							...
							<div className="flex md:flex-row sm:flex-col sm:space-y-4  text-center">
								...
								<div className="my-auto mx-auto bg-blue-50 rounded-lg border-2 border-blue-400 border-solid shadow-md">
									<img
										...
										className="my-auto w-[30rem] h-[30rem]"
									/>
								</div>
							</div>
						</div>
			...
			<SectionWrapper
				...
				backgroundClassName="dark:bg-gradient-to-b from-green-300 to-[#7ceb87] bg-[linear-gradient(180deg,#ffffff,#c3f7c8)] dark:bg-[linear-gradient(180deg,#181a1b,#0b5121)]"
			>
						...
						<div className="flex flex-col text-center space-y-4 items-center justify-center p-10">
							<div className="flex flex-row text-center font-semibold space-x-3 pt-10 py-6 px-5">
								...
								<div>
									...
									<ul className="text-left list-decimal space-y-4">
										<li>
											Commune facilitates easy sharing and discovery of reusable
											modules among developers.
										</li>
										<li>
											Developers can contribute their own modules and benefit
											from the shared pool of resources, saving time and effort.
										</li>
									</ul>
								</div>
								...
								<div>
									...
									<ul className="text-left list-decimal space-y-4">
										...
										<li>
											...
											ensuring consistent quality and accelerating their project
											timelines.
										</li>
									</ul>
								</div>
			...
			<SectionWrapper
				...
				backgroundClassName="dark:bg-gradient-to-b from-yellow-300 to-[#fff7a1] bg-[linear-gradient(180deg,#ffffff,#fff7a1)] rounded-lg shadow-xl dark:bg-[linear-gradient(180deg,#181a1b,#514a00)]"
			>
							...
							<div className="flex flex-col text-center font-semibold space-x-3 pt-10 py-6 px-5">
								<div>
									...
									<ul className="text-left space-y-4">
										<li>
											Commune supports horizontal scaling, enabling the addition
											of more resources to handle increased demand.
										</li>
										<li>
								...
								<div>
									...
									<ul className="text-left space-y-4">
										<li>
											Commune seamlessly integrates with popular cloud platforms
											and services.
										</li>
										<li>
											Developers can leverage the scalability and elasticity of
											cloud resources to accommodate varying workloads.
										</li>
									</ul>
								</div>
							</div>
			...
			<SectionWrapper
				...
				backgroundClassName="dark:bg-gradient-to-b from-red-300 to-[#ff8f8f] bg-[linear-gradient(180deg,#ffffff,#ff8f8f)] dark:bg-[linear-gradient(180deg,#181a1b,#760000)] rounded-lg shadow-xl"
			>
			...
			<SectionWrapper
				...
				backgroundClassName="dark:bg-gradient-to-b from-pink-300 to-[#ffd6f5] bg-[linear-gradient(180deg,#ffffff,#ffd6f5)] dark:bg-[linear-gradient(180deg,#181a1b,#4c0039)] rounded-lg shadow-xl"
			>
				<div className="text-black dark:text-white">
					<div className="pt-6 text-right w-full">
						...
						<div className="flex flex-col text-center space-y-10 font-semibold space-x-3 pt-10 py-6 px-5">
							<div className="flex flex-row items-center justify-center">
								<div className="mx-auto font-bold">
									...
									<ul className="text-left space-y-4 list-disc">
										...
										<li>
											The module's vote weight is determined by the amount
											staked on it.
										</li>
									</ul>
								</div>
							...
							<div className="flex flex-row items-center justify-center">
								<div className="mx-auto">
									...
									<ul className="text-left space-y-4 list-disc">
										<li>
											Voters are incentivized to be Honest by Receiving Part of
											the Reward
										</li>
										<li>
						...
						<div className="flex flex-col space-y-24 p-10 sm:justify-center sm:items-center">
							<div className="flex md:flex-row sm:flex-col sm:space-y-4 text-center items-center justify-center">
								<div className="my-auto mx-auto bg-gray-100 rounded-lg border-2 border-zinc-700 dark:border-gray-100 border-solid shadow-md">
									<img
										src="./img/frontpage/_3.png"
										className="mt-5 mx-auto w-[35rem] h-[25rem]"
									/>
								</div>
								<div className="w-[30rem] mx-auto my-auto font-semibold">
									<ul className="text-left space-y-10 list-disc">
										<li>
											Application validators validate modules that best performs
											that application
										</li>
										<li>
											Each validator has its own objective and is responsible
											for calculating an appropriate reward it can vote based on
										</li>
										<li>
			...
			<SectionWrapper
				...
				backgroundClassName="bg-[linear-gradient(180deg,#fff,#fff)] dark:bg-[linear-gradient(180deg,#151718,#151718)] rounded-lg shadow-xl"
			>
				<div className="text-black dark:text-white">
					<div className="pt-6 text-right w-full pb-6">
						<h1 className="text-5xl pb-3 text-center">
							Read Our Whitepaper 📄
						</h1>
						<div className="flex flex-col">
							...
							<div className="-mt-2 flex justify-center rounded-xl lg:mb-4">
								...
								>
									<div className="flex flex-row bg-[#FF8F8F] hover:bg-[#FF8F8F] dark:bg-[#760000] dark:hover:bg-[#760000] text-white font-bold py-2 px-4 mt-10 rounded-lg shadow-md hover:shadow-xl duration-300">
