  ...
  return (
    <div id={id} className="">
      <div className="py-10 px-5 my-5 ">
        <div
          className={`${backgroundClassName} mt-10 flex lg:flex-row flex-col items-center justify-center gap-10 rounded-3xl hover-effect w-[95%] mx-auto dark:bg-black`}
          style={{ boxShadow: `1px 6px 50px 10px ${id}` }}
        >
              ...
              <div className=" flex md:flex-row sm:flex-col sm:space-y-4  text-center ">
                ...
                <div className="my-auto mx-auto">
                  <img
                    ...
                    className="my-auto w-[30rem] h-[30rem] p-2"
                  />
                </div>
              </div>
            </div>
      ...
      >
        <div className=" text-black mt-10">
          <div className="pt-6 text-right w-full">
            <h1 className=" text-5xl pb-3 text-center dark:text-white">
              Reusability ♻️
            </h1>
