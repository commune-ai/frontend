...
const ExchangeRow = ({ exchange, index }: { exchange: any; index: number }) => (
	<tr className="h-12">
		<td className="px-3 md:px-6 py-4 text-center text-sm font-medium text-gray-900">
			{index + 1}
		</td>
		...
		<td className="px-3 md:px-6 py-4  text-center text-md font-medium">
			<a href={exchange.link} className="text-blue-700 hover:text-blue-800">
				<div className="inline-block bg-blue-700 rounded-lg shadow-lg hover:shadow-2xl text-center hover:bg-blue-600 duration-200 text-white font-sans font-semibold px-2 py-2">
					Trade
				</div>
			</a>
		</td>
			...
			<table className={classNames(classes.table, "rounded-md")}>
				<thead className="bg-gray-50 dark:!bg-[#1d1f20]">
					<tr>
						<th
							scope="col"
							className="px-3 md:px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-white"
						>
							#
						</th>
						<th
