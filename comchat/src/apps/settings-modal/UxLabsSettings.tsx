  ...
  return <>
    ...
    <FormControl orientation='horizontal' sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <Typography level='body-xs'>
        <Link href='https://github.com/smart-window/com-chat/issues/282' target='_blank'>Persona Creator</Link> · <Link href='https://github.com/smart-window/com-chat/issues/192' target='_blank'>Auto Diagrams</Link> · Imagine · Relative chat size · Text Tools · LLM Overheat
      </Typography>
    </FormControl>
